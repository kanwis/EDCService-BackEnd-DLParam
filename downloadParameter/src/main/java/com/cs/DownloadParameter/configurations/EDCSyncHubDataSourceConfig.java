package com.cs.DownloadParameter.configurations;
...
@EntityScan(basePackages = {"com.cs.DownloadParameter.entities"})  // scan JPA entities manually
@EnableJpaRepositories(
      basePackages = "com.cs.DownloadParameter.repositories",
      entityManagerFactoryRef = "edcSyncHubEntityManagerFactory",
      transactionManagerRef = "edcSyncHubTransactionManager"
)
...
//	    properties.put("hibernate.hbm2ddl.auto", "update");
		return builder.dataSource(edcSyncHubDataSource()).packages("com.cs.DownloadParameter.entities") // Specify the  package  for entities
